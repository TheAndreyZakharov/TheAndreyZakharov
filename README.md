    ...
    <tr>
      ...
      <td style="text-align: center; vertical-align: top; padding: 20px;" rowspan="2">
        <div style="will-change: transform;">
          <img src="https://count.getloli.com/@ProfileViews?name=ProfileViews&theme=rule34&padding=8&offset=0&align=center&darkmode=0" alt="Profile Views Counter" width="400" />
        </div>
