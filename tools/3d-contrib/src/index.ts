...
import * as aggregate from './aggregate-user-info.js';
import * as template from './color-template.js';
import * as create from './create-svg.js';
import * as f from './file-writer.js';
import * as r from './settings-reader.js';
import * as client from './github-graphql.js';
